      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-gray-900">ReportAssist</span>
          </div>
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-24 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            ...
            <Link
              href="/signin"
              className="bg-white text-gray-700 px-8 py-3 rounded-lg font-medium border border-gray-300 hover:border-gray-400 transition-colors text-base"
            >
              Sign in
            </Link>
          </div>
      ...
      <section className="bg-white border-t border-gray-200 py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-start p-6 rounded-xl border border-gray-200 bg-gray-50">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Custom report forms</h3>
              <p className="text-sm text-gray-500">Admins can design report templates with a drag-and-drop form builder — add text, number, select, and checkbox fields.</p>
            </div>
            <div className="flex flex-col items-start p-6 rounded-xl border border-gray-200 bg-gray-50">
              <div className="w-10 h-10 rounded-lg bg-indigo-100 flex items-center justify-center mb-4">
                <svg className="w-5 h-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-sm text-gray-500">Members are prompted with a modal to submit their daily report as soon as they log in — no report gets missed.</p>
            </div>
            <div className="flex flex-col items-start p-6 rounded-xl border border-gray-200 bg-gray-50">
              <div className="w-10 h-10 rounded-lg bg-indigo-100 flex items-center justify-center mb-4">
                <svg className="w-5 h-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-sm text-gray-500">View, filter, and review all submitted reports by team member or date from a centralized admin dashboard.</p>
            </div>
          </div>
        </div>
      </section>
